      ...
      <div className="container mx-auto px-4">
        <div className="relative h-[420px] md:h-[560px] overflow-hidden rounded-sm">
          ...
          <div className="absolute inset-x-0 bottom-0 p-5 md:p-10 flex items-end justify-between gap-6">
            <div className="max-w-[640px]">
              <p className="text-4xl md:text-6xl italic font-light tracking-wide font-serif">
                Hisma
              </p>
        ...
        <div className="max-w-5xl pt-10 pb-12">
          <p className="text-base md:text-2xl leading-relaxed text-white/90">
            ...
            captivates the senses. Its vast expanse of golden sand dunes,
            sculpted by the winds of time, creates a mesmerizing landscape that
            stretches as far as the eye can see. As the sun sets, painting the
            sky with vivid hues.{" "}
          </p>
        </div>
